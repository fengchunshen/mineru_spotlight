...
> 完整文档: http://localhost:39020/docs
...
**检查 Worker 健康状态**
```bash
curl -X POST http://localhost:39021/predict \
...
#   m i n e r u _ s p o t l i g h t  
 